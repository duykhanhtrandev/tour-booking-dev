...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHV5a2hhbmh0cmFuZGV2IiwiYSI6ImNsY29iaTR5djFocWEzcHA4b2xrMzlhcXAifQ.slmnIF2oq6gwtB64MJVjlg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/duykhanhtrandev/clcocuvwx000p14rwzy4uy2j2',
    scrollZoom: false // center: [106.2951947410133, 20.199529769753415],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.description, ": ").concat(loc.day, " ng\xE0y</p>")).addTo(map); // Extend map bounds to include current location
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Lỗi đăng xuất! Thử lại.');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Tài khoản được tạo và đăng nhập thành công!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " c\u1EADp nh\u1EADt th\xE0nh c\xF4ng!"));
          }
...
var bookBtn = document.getElementById('book-tour'); // DELAGATION
  ...
  _regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          document.querySelector('.btn--save-password').textContent = 'Đang cập nhật...';
